...
const { handleCPUCoolerIntent } = require('./cpu-cooler-model'); // Assuming you have this module
const { handleStorageIntent } = require('./storage-model'); // Assuming you have this module
const { handlePSUIntent } = require('./psu-model'); // Assuming you have this module
...
app.post('/webhook', (req, res) => {
    ...
    // 3. Handle other component intents (assuming these might still be specific lists for now)
    // If you genericize these in Dialogflow, you would change these to single 'else if' checks.
